...
class Gaussian():
    ...
    def calculate_mean(self):
        ...
        #TODO: DONE: Calculate the mean of the data set. Remember that the data set is stored in self.data
    ...
    def plot_histogram(self):
        ...
        # TODO: DONE: Plot a histogram of the data_list using the matplotlib package.
    ...
    def pdf(self, x):
        ...
        # TODO: DONE: Calculate the probability density function of the Gaussian distribution
        #       at the value x. You'll need to use self.stdev and self.mean to do the calculation
        return (1.0 / (self.stdev * math.sqrt(2*math.pi))) * math.exp(-.5*((x-self.mean) / self.stdev) ** 2)
    ...
    def plot_histogram_pdf(self, n_spaces = 50):
        ...
        #TODO: DONE: Nothing to do for this method. Try it out and see how it works.
    ...
    def __add__(self, other):
        ...
        # TODO: DONE: calculate the mean and standard deviation of the sum of two Gaussians
